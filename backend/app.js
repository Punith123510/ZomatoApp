...
const resRoutes = require('./routes/route');   // importing routes from routes file
...
mongoose.connect('mongodb+srv://root:Qwerty%40123@cluster0-zcikl.mongodb.net/TestDB?retryWrites=true&w=majority',
